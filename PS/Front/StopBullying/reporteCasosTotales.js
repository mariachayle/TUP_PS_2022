...
function crearGrafico() {
    ...
    $.ajax({
        url: "https://localhost:5001/Denuncias/ObtenerDenunciasReporteTotal",
        type: "GET",
            ...
            if (result.ok) {
                ...
                chart1 = new Chart(ctx, {
                    ...
                    data: {
                        labels: rotulos,
                        datasets: [{
                            label: 'Denuncias Totales por año',
                            data: datos,
...
function crearGrafico2() {
    ...
    $.ajax({
        url: "https://localhost:5001/Denuncias/ReporteTotalEstado",
        type: "GET",
        //  contentType: "application/json",
        success: function (result) {
            if (result.ok) {
                ...
                chart2 = new Chart(ctx, {
                    ...
                    data: {
                        labels: rotulos,
                        datasets: [{
                            label: 'Estados de Denuncias Totales de este año',
                            data: datos,
                            borderColor: ['rgba(255, 99, 132, 1)',
                                'rgba(54, 162, 235, 1)',
                                'rgba(255, 206, 86, 1)'],
...
function grafico() {
    ...
    $.ajax({
        url: 'https://localhost:5001/Reporte/total?param1=' + fechaDesde + '&param2=' + fechaHasta,
        type: "GET",
        success: function (result) {
            if (result.ok) {
