...
function crearGrafico() {
    ...
    $.ajax({
        url: "https://localhost:5001/Denuncias/ObtenerDenunciasReporteResueltos",
        type: "GET",
            ...
            if (result.ok) {
                ...
                chart1 = new Chart(ctx, {
                    ...
                    data: {
                        labels: rotulos,
                        datasets: [{
                            label: 'Denuncias Resueltas por año',
                            data: datos,
...
function crearGrafico2() {
    ...
    $.ajax({
        url: "https://localhost:5001/Denuncias/ReporteResueltosEstado",
        type: "GET",
        //  contentType: "application/json",
        success: function (result) {
            if (result.ok) {
                ...
                for (var i in denuncia) {
                     rotulos.push(denuncia[i].denuncias.emergencia);
                     datos.push(denuncia[i].cantidad);
                }
                console.log(rotulos);
                console.log(datos);   
                ...
                chart2 = new Chart(ctx, {
                    ...
                    data: {
                        labels: ["Regular","Emergencia"],
                        datasets: [{
                            label: 'Denuncias segun Emergencia de este año',
                            data: datos,
                            borderColor: ['rgba(255, 99, 132, 1)',
                            'rgba(54, 162, 235, 1)',
                            'rgba(255, 206, 86, 1)'],
...
function grafico() {
    ...
    $.ajax({
        url: 'https://localhost:5001/Reporte/totalResuelto?param1=' + fechaDesde + '&param2=' + fechaHasta,
        type: "GET",
        success: function (result) {
            if (result.ok) {
                ...
                myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels: ["Regular","Emergencia"],
                        datasets: [{
                            label: 'Denuncias segun si son de Emergencia en el tiempo especificado',
                            data: datos,
                            backgroundColor: [
                                'rgba(255, 99, 132, 1)',
                                'rgba(54, 162, 235, 1)',
